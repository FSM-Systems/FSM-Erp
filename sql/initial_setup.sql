...
INSERT INTO menu VALUES (20, 'Suppliers', true, 22, 'suppliers', 'List of company suppliers', 'new_supplier', 1, 1); 
INSERT INTO menu VALUES (21, 'Employee Notes', true, 10000, 'employee_notes', 'Add notes on performance of employees', 'new_employee_note', 18, 1); 
INSERT INTO menu VALUES (22, 'Fuel Register', true, 10000, 'fuel_register', 'Add records of fuel consumption of equipment', 'new_fuel_register', 17, 1); 
INSERT INTO menu VALUES (1, 'Users Setup', true, 8, 'system_users_setup', 'Add or update System Users', 'new_system_user', 3, 1); 
INSERT INTO menu VALUES (11, 'Desktop Icons', true, 10, 'desktop_icons_setup', 'Creates the icons on Desktop and you can bind menu items to the group', 'new_desktop_icon', 3, 1); 
INSERT INTO menu VALUES (9, 'Models', true, 4, 'equipment_models', 'Add or modify Equipment Models (Generic)', 'new_equipment_model', 2, 1); 
INSERT INTO menu VALUES (5, 'Warehouse Setup', true, 12, 'warehouse_setup', 'Setup Warehouses', 'new_warehouse', 3, 1); 
INSERT INTO menu VALUES (3, 'Menu Setup', true, 5, 'system_menu_setup', 'Setup Main Menu', 'new_system_menu_config', 3, 1); 
INSERT INTO menu VALUES (2, 'Owned', true, 2, 'equipment_setup', 'Insert and Delete Equipment', 'new_equipment', 2, 1); 
INSERT INTO menu VALUES (18, 'Goods Issued Notes', true, 18, 'goods_issue_notes', 'Issue items from stock, print the document and update the warehouse', 'new_goods_issue_note', 1, 1); 
INSERT INTO menu VALUES (15, 'In Stock Items', true, 20, 'in_stock_items', 'View items in stock', 'new_in_stock_item', 1, 1); 
INSERT INTO menu VALUES (8, 'Warehouse Items', true, 14, 'warehouse_items_setup', 'Add Items and Information (SKU) for use in the warehouses', 'new_warehouse_item', 1, 1); 
